...
//
G4VParticleChange*
G4CerenkovOpticks::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
...
void G4CerenkovOpticks::BuildThePhysicsTable()
{
...
G4double G4CerenkovOpticks::GetMeanFreePath(const G4Track&,
                                           G4double,
                                           G4ForceCondition*)
{
  return 1.;
...
G4double
  G4CerenkovOpticks::GetAverageNumberOfPhotons(const G4double charge,
                                        const G4double beta, 
