...
//
G4VParticleChange*
G4ScintillationOpticks::AtRestDoIt(const G4Track& aTrack, const G4Step& aStep)
...
//
G4VParticleChange*
G4ScintillationOpticks::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
...
#endif
            anaHelper->AddG4ScintPhotons(Num);
...
void G4ScintillationOpticks::BuildThePhysicsTable()
{
...
G4double G4ScintillationOpticks::GetMeanFreePath(const G4Track&,
                                          G4double ,
...
G4double G4ScintillationOpticks::
