...
//---------------------------------------------------------------------------
//
// ClassName:   G4OpticalPhysicsOpticks
//
...
{
    if(verboseLevel > 0)
        G4cout << "G4OpticalPhysicsOpticks:: Add Optical Physics Processes" << G4endl;
    ...
    if(!pManager)
    {
        ...
        G4Exception("G4OpticalPhysicsOpticks::ConstructProcess()", "", FatalException, ed);
        return;
    }
    ...
    G4ScintillationOpticks* scint       = new G4ScintillationOpticks();
    ...
    while((*myParticleIterator)())
    {
        ...
        if(!pManager)
        {
            ...
            G4Exception("G4OpticalPhysicsOpticks::ConstructProcess()", "", FatalException,
                        ed);
