...
G4_DECLARE_PHYSCONSTR_FACTORY(G4OpticalPhysicsOpticks);

G4ThreadLocal G4ScintillationOpticks*     G4OpticalPhysicsOpticks::fScintillationProcess = nullptr;
G4ThreadLocal G4CerenkovOpticks*          G4OpticalPhysicsOpticks::fCerenkovProcess = nullptr;
G4ThreadLocal G4OpWLS*             G4OpticalPhysicsOpticks::fWLSProcess = nullptr;
G4ThreadLocal G4OpAbsorption*      G4OpticalPhysicsOpticks::fAbsorptionProcess = nullptr;
G4ThreadLocal G4OpRayleigh*        G4OpticalPhysicsOpticks::fRayleighProcess = nullptr;
G4ThreadLocal G4OpMieHG*           G4OpticalPhysicsOpticks::fMieProcess = nullptr;
G4ThreadLocal G4OpBoundaryProcess* G4OpticalPhysicsOpticks::fBoundaryProcess = nullptr;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4OpticalPhysicsOpticks::G4OpticalPhysicsOpticks(G4int verbose, const G4String& name)
...

{
  ...
  //fMessenger = new G4OpticalPhysicsMessenger(dynamic_cast<G4OpticalPhysicsMessenger*>(this));
  fMessenger = nullptr;
...
G4OpticalPhysicsOpticks::~G4OpticalPhysicsOpticks()
{
  delete fMessenger;
  fMessenger = nullptr;
}
...
void G4OpticalPhysicsOpticks::PrintStatistics() const
{
...
void G4OpticalPhysicsOpticks::ConstructParticle()
{
...
void G4OpticalPhysicsOpticks::ConstructProcess()
{
  if(verboseLevel>0)
  ...
  fScintillationProcess = new G4ScintillationOpticks();
  ...
  fCerenkovProcess = new G4CerenkovOpticks();
...
void G4OpticalPhysicsOpticks::SetScintillationYieldFactor(G4double val)
{
   fYieldFactor = val;
...
void G4OpticalPhysicsOpticks::SetScintillationExcitationRatio(G4double val)
{
...
void G4OpticalPhysicsOpticks::SetMaxNumPhotonsPerStep(G4int val)
{
...
void G4OpticalPhysicsOpticks::SetMaxBetaChangePerStep(G4double val)
{
...
void G4OpticalPhysicsOpticks::SetCerenkovStackPhotons(G4bool val)
{
...
void G4OpticalPhysicsOpticks::SetCerenkovTrackSecondariesFirst(G4bool val)
{
...
void G4OpticalPhysicsOpticks::SetCerenkovVerbosity(G4int ver)
{
...
void G4OpticalPhysicsOpticks::SetWLSTimeProfile(G4String name)
{
...
void G4OpticalPhysicsOpticks::SetWLSVerbosity(G4int ver)
{
  fWLSVerbosity = ver;
  if (fWLSProcess) {
...
void G4OpticalPhysicsOpticks::SetScintillationByParticleType(G4bool val)
{
...
void G4OpticalPhysicsOpticks::SetScintillationTrackSecondariesFirst(G4bool val)
{
...
void G4OpticalPhysicsOpticks::SetScintillationTrackInfo(G4bool val)
{
...
void G4OpticalPhysicsOpticks::SetScintillationVerbosity(G4int ver)
{
...
void G4OpticalPhysicsOpticks::SetAbsorptionVerbosity(G4int ver)
{
...
void G4OpticalPhysicsOpticks::SetRayleighVerbosity(G4int ver)
{
...
void G4OpticalPhysicsOpticks::SetMieVerbosity(G4int ver)
{
  fMieVerbosity = ver;
  if (fMieProcess) {
...
void G4OpticalPhysicsOpticks::SetBoundaryVerbosity(G4int ver)
{
...
void G4OpticalPhysicsOpticks::SetTrackSecondariesFirst(G4OpticalProcessIndex index,
...
void G4OpticalPhysicsOpticks::SetFiniteRiseTime(G4bool b)
{
  fFiniteRiseTime = b;
  if (fScintillationProcess) {
    fScintillationProcess->SetFiniteRiseTime(fFiniteRiseTime);
...
void G4OpticalPhysicsOpticks::SetInvokeSD(G4bool b)
{
  fInvokeSD = b;
  if (fBoundaryProcess) {
    fBoundaryProcess->SetInvokeSD(fInvokeSD);
...
void G4OpticalPhysicsOpticks::SetScintillationStackPhotons(G4bool stackingFlag)
{
...
void G4OpticalPhysicsOpticks::Configure(G4OpticalProcessIndex index, G4bool isUse)
{
